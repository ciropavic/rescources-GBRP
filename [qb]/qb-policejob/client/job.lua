...
RegisterNetEvent('evidenceLocker1')
AddEventHandler('evidenceLocker1', function()
    if onDuty then
...
RegisterNetEvent('evidenceLocker2')
AddEventHandler('evidenceLocker2', function()
    if onDuty then
...
RegisterNetEvent('evidenceLocker3')
AddEventHandler('evidenceLocker3', function()
    if onDuty then
...
RegisterNetEvent('evidenceTrash')
AddEventHandler('evidenceTrash', function()
    if onDuty then
...
RegisterNetEvent('police:personalstash')
...
AddEventHandler("police:fingerprint", function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
        TriggerServerEvent("police:server:showFingerprint", playerId)
