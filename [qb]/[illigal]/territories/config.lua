...
Config = {
  ...
  InfluenceTick     = 10,           -- how long between influence gain/loss tick?
  ...
  UsingItemLimit    = true,           -- if using esx item limits
  ...
  GangJobs = {                        -- List all jobs that are able to contest for and control territories here.
    "ballas",                          -- NOTE: Don't need to include police. Thats taken from PoliceJobs table above.
    "vagos",
    "police",
    "mechanic",
  }
...
Territories = {
  ["East V"] = {
    ...
    canSell = {"sandwich"},                                                 -- Check other examples on how to sell drugs in a zone.

    areas = {                                             -- Areas are responsible for the large square blips on the map.
      [1] = { 
        location  = vector3(904.06,-164.28,73000.97),
        width     = 350.0,
        height    = 200.0,
        heading   = 60,
        display   = 3
      ...
      [2] = {
        location  = vector3(789.57,-328.67,73000.97),
        width     = 300.0,
        height    = 200.0,
        heading   = 60,
        display   = 3        
    ...
    actions = { 
      ["entry"] = {
        ...
        location = vector3(1005.76,-114.52,73000.50),
      },
      ["exit"] = {
        helpText = _U["leave_laundry"],
        location = vector3(1118.89,-3193.33,-40000.00),
      },
      ["gather_money"] = {
  ...
  ["Davis"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(53.95,-1818.36,2700.66),
        width     = 390.0,
        height    = 210.0,
        heading   = 50,
        display   = 3
      ...
      [2] = {
        location  = vector3(169.062, -1587.663, 77000.28895),
        width     = 260.0,
        height    = 300.0,
        heading   = 50,
        display   = 3
    ...
    actions = {
      ["entry"] = {
        ...
        location = vector3(109.08, -1797.75, 27.07),
      },
      ["exit"] = {
  ...
  ["ChamberlainHills"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(-147.9323, -1600.784, 38000.29156),
        width     = 200.0,
        height    = 280.0,
        heading   = 50,
        display   = 3
    ...
    actions = {
      ["entry"] = {
        ...
        location = vector3(-94.420951843262, -1648.73828125, 32000.196632385254),
      },
      ["exit"] = {
        helpText = _U["leave_methlab"],
        location = vector3(997.0199, -3200.684, -36000.39373),
      },
      ["cook_meth"] = {
  ...
  ["Rancho"] = {
    ...
    canSell = {"actionfigure"},
    areas = {
      [1] = {
        location  = vector3(320.2412, -2039.633, 28000.96141),
        width     = 290.0,
        height    = 220.0,
        heading   = 50,
        display   = 3
      ...
      [2] = {
        location  = vector3(413.2437, -1782.743, 40000.27221),
        width     = 370.0,
        height    = 300.0,
        heading   = 50,
        display   = 3
    ...
    actions = {
      ["entry"] = {
        ...
        location = vector3(510.74, -1951.56, 24.99),
      },
      ["exit"] = {
      ...
      ["gather_cocaine"] = {
        helpText    = _U["trim_brick"],
        progText    = _U["trim_brick"],
