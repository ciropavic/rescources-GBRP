...
AddEventHandler("hud:client:ChangeCircle", function()
    RequestStreamedTextureDict("circlemap", false)
        ...
        if Config.ShowMapNotif == true then
            ...
            DisplayRadar(1)
            Wait(500)
        if Config.ShowMapBorder == true then
...
AddEventHandler("hud:client:ChangeSquare", function()
    RequestStreamedTextureDict("squaremap", false)
        ...
        if Config.ShowMapNotif == true then
            ...
            SetMinimapComponentPosition("minimap", "L", "B", 0.0, -0.047, 0.1638, 0.216)
            ...
            -- 0.262 = map stretched
            -- 0.315 = map shorten
            SetMinimapComponentPosition('minimap_blur', 'L', 'B', -0.01, 0.025, 0.262, 0.315)
            SetBlipAlpha(GetNorthRadarBlip(), 0)
            SetMinimapClipType(0)
            DisplayRadar(0)
            SetRadarBigmapEnabled(true, false)
