...
QBCore.Functions.CreateUseableItem('paintball-ammo', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_PAINTBALL', 20, item)
end)

QBCore.Functions.CreateUseableItem('hunting-ammo', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_HUNTING', 10, item)
end)

QBCore.Functions.CreateUseableItem('pd_pistol_ammo', function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateUseableItem('pd_rifle_ammo', function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    local Job = Player.PlayerData.job.name
    if Job == "police" then
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_RIFLE', 30, item)
...
QBCore.Functions.CreateUseableItem('pd_smg_ammo', function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    local Job = Player.PlayerData.job.name
    if Job == "police" then
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_SMG', 20, item)
...
QBCore.Functions.CreateUseableItem('pd_shotgun_ammo', function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    local Job = Player.PlayerData.job.name
    if Job == "police" then
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_SHOTGUN', 10, item)
