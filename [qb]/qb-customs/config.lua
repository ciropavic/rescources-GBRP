...
bennyGarages = {
    [1] = {coords = vector4(462.6101, -1019.65, 28.105, 88.88), useJob = true, job = {"police"}},
    [2] = {coords = vector4(-34.11, -1066.28, 28.4, 337.67), useJob = true, job = {"mechanic"}} 
}
...
vehicleCustomisationPrices = {
    cosmetics = {price = 0},
    respray = {price = 25},
    performance = {prices = {2500, 6500, 15000, 20000, 30000, 44500}},
    turbo = {price = 90000},
    wheels = {price = 0},
