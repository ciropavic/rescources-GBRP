...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = {['cash'] = 500, ['4500'] = 2000, ['crypto'] = 0 } -- ['type']=startamount - Add or remove money types for your server (for ex. ['blackmoney']=0), remember once added it will not be removed from the database!
...
QBConfig.Player.HungerRate = 5.2 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 4.8 -- Rate at which thirst goes down.
...
QBConfig.Server.discord = "https://discord.gg/GVEVREZE" -- Discord invite link
