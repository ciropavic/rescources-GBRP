                        ...
                        if InVehicle then
                            ...
                            if IsControlJustReleased(0, 38) then
                                QBCore.Functions.TriggerCallback('qb-garbagejob:server:CheckBail', function(DidBail)
                                    if DidBail then
                                        BringBackCar()
                                        QBCore.Functions.Notify("You have $200,- deposit returned!")
                                    else
                                ...
                                QBCore.Functions.TriggerCallback('qb-garbagejob:server:HasMoney', function(HasMoney)
                                    if HasMoney then
                                        ...
                                        QBCore.Functions.SpawnVehicle("trash2", function(veh)
                                            ...
                                            IsWorking = true
                                            SetGarbageRoute()
                                            QBCore.Functions.Notify("You have $200,- deposit paid!")
                                            QBCore.Functions.Notify("You have started working, location marked on GPS!")
                                        end, coords, true)
                                    else
                                        QBCore.Functions.Notify("You have not enough money for the deposit.. Deposit costs are $200,-")
                                    end
                                end)
                            end
                        end
                                        ...
                                        if TruckDist < 2 then
                                            ...
                                            if IsControlJustPressed(0, 51) then
                                                ...
                                                if (AmountOfBags - 1) == 0 then
                                                    ...
                                                    Earnings = Earnings + math.random(150, 200)
