...
RegisterNetEvent('qb-clothing:client:openclothes')
AddEventHandler('qb-clothing:client:openclothes', function()
    customCamLocation = nil
    openMenu({
        {menu = "character", label = "Clothing", selected = true},
        {menu = "accessoires", label = "Accessories", selected = false}
...
RegisterNetEvent('qb-clothing:client:openhair')
AddEventHandler('qb-clothing:client:openhair', function()
    customCamLocation = nil
    openMenu({
        {menu = "clothing", label = "Hair", selected = true},
    })
...
RegisterNetEvent('qb-clothing:client:opensurgeon')
AddEventHandler('qb-clothing:client:opensurgeon', function()
    customCamLocation = nil
    openMenu({
        {menu = "clothing", label = "Features", selected = true},
    })
