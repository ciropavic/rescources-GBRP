...
QBCore.Commands.Add("giveitem", "Give An Item (God Only)", {{name="id", help="Player ID"},{name="item", help="Name of the item (not a label)"}, {name="amount", help="Amount of items"}}, true, function(source, args)
