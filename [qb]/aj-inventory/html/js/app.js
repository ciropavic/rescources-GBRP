...
$(document).on('click', '.weapon-attachments-back', function(e){
    e.preventDefault();
    $("#aj-inventory").css({"display":"block"});
    $("#aj-inventory").animate({
        left: 0+"vw"
    }, 200);
...
(() => {
    ...
    Inventory.dropslots = 30;   /* 30 */
    Inventory.droplabel = "Drop";   /* "Drop"; */
